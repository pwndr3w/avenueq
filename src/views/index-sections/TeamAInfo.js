          ...
          <IndexNavbar />
            <div className="wrapper">
                ...
                <Container>
                    ...
                    <TeamInfoDetail castName="프린스턴" actorType="1" src={["황두현/프린스턴/Duhyun Hwang"]} />                            
                    <TeamInfoDetail castName="케이트" castType ="2" actorType="1" src={["이신정/케이트/Sinjeong Lee", "홍세나/케이트/Serena Hong"]} />                            
                    <TeamInfoDetail castName="브라이언" actorType="1" src={["김연천/브라이언/Yeoncheon Kim"]} /> 
                    <TeamInfoDetail castName="이브" castType="2" actorType="1" src={["김보연/이 브/Boyeon Kim", "임겨레/이 브/Kyeorei Lim"]} /> 
                    <TeamInfoDetail castName="니키 & 로드" actorType="1" src={["이원종/니 키/Wonjong Lee", "김준범/로 드/Junbeom Kim"]} />  
                    <TeamInfoDetail castName="루시 & 개리 & 트래키" actorType="1" src={["안상현/루 시/Sanghyeon An", "김설이/개 리/Seolyi Kim", "김무준/트래키/Mujun Kim"]} />  
                    <TeamInfoDetail castName="베드 베어즈" actorType="1" src={["김재혁/베드 베어즈 남/Jaehyeok Kim", "박은영/베드 베어즈 여/Eunyoung Park"]} />    
                    <TeamInfoDetail actorType="1" src={["김민성/베드 베어즈 남/Minsung Kim", "조희령/베드 베어즈 여/Heeryeong Jo"]} />
